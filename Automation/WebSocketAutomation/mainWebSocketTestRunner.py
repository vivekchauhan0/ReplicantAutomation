...
ap.add_argument("-q", "--URL", required=True, help="Charles True or False")
...
APP_ROOT = os.path.join(BASE_DIR, 'AutomationResults/WebSocketAutomation')
...
def mainTest():
    ...
    pytest.main(["-vvv", "-s", os.path.join(BASE_DIR,'WebSocketAutomation','chatautomationwebsocket.py'), "--html=" + testArgs_HTML, "--excelreport=" + testArgs_Excel, "--json=" + testArgs_JSON])
    print("Web Test Done")
